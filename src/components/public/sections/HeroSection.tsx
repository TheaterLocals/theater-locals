...
// Atmospheric dark gradients — one per transformation moment
const SLIDE_BG = [
  "bg-[radial-gradient(ellipse_at_center,_#0d2e1a_0%,_#000_70%)]",   // Seaweed — deep forest
  "bg-[radial-gradient(ellipse_at_center,_#2a0a0a_0%,_#000_70%)]",   // Tuna — deep crimson
  "bg-[radial-gradient(ellipse_at_center,_#2a1800_0%,_#000_70%)]",   // Hayama beef — ember
];
...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
      ...
      {/* Background — crossfading dark atmospheres */}
      {SLIDE_BG.map((bg, i) => (
        <div
          key={i}
          className={`absolute inset-0 transition-opacity duration-1500 ${bg} ${
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h1
          className="font-playfair text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-[1.1] mb-8"
        >
          {lang === "en" ? (
            <>
              Taste local tonight.
        ...
        {/* Single CTA — theater window styling */}
        <a
